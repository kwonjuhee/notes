...
const getBoxCustomProperties = (props: BoxProps) => {
  ...
  return {
    boxCustomProperties: {
      ...
      "--box-background-color": backgroundColor ? `var(--bg-${backgroundColor}-subtle)` : undefined,
      ...
      "--box-border-color": borderColor ? `var(--border-${borderColor})` : undefined,
      "--box-border-radius": borderRadius ? `var(--radius-${borderRadius})` : undefined,
    },
    boxProps: rest,
  };
};
